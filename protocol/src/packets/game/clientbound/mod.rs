...
pub fn decode_packet(id: i32, buf: &mut BytesMut) -> Result<PacketGameClientbound> {
    match id {
        ...
        41 => Ok(PacketGameClientbound::MoveEntityPosPacket(MoveEntityPosPacket::decode(buf)?)),
        42 => Ok(PacketGameClientbound::MoveEntityPosRotPacket(MoveEntityPosRotPacket::decode(buf)?)),
        43 => Ok(PacketGameClientbound::MoveEntityRotPacket(MoveEntityRotPacket::decode(buf)?)),
...
pub fn encode_packet(packet: PacketGameClientbound, buf: &mut BytesMut) {
    ...
    match packet {
        AddEntityPacket(deref_packet) => { buf.set_mc_var_int(0); deref_packet.encode(buf); },
        AddExperienceOrbPacket(deref_packet) => { buf.set_mc_var_int(1); deref_packet.encode(buf); },
        AddGlobalEntityPacket(deref_packet) => { buf.set_mc_var_int(2); deref_packet.encode(buf); },
        AddMobPacket(deref_packet) => { buf.set_mc_var_int(3); deref_packet.encode(buf); },
        AddPaintingPacket(deref_packet) => { buf.set_mc_var_int(4); deref_packet.encode(buf); },
        AddPlayerPacket(deref_packet) => { buf.set_mc_var_int(5); deref_packet.encode(buf); },
        AnimatePacket(deref_packet) => { buf.set_mc_var_int(6); deref_packet.encode(buf); },
        AwardStatsPacket(deref_packet) => { buf.set_mc_var_int(7); deref_packet.encode(buf); },
        BlockBreakAckPacket(deref_packet) => { buf.set_mc_var_int(8); deref_packet.encode(buf); },
        BlockDestructionPacket(deref_packet) => { buf.set_mc_var_int(9); deref_packet.encode(buf); },
        BlockEntityDataPacket(deref_packet) => { buf.set_mc_var_int(10); deref_packet.encode(buf); },
        BlockEventPacket(deref_packet) => { buf.set_mc_var_int(11); deref_packet.encode(buf); },
        BlockUpdatePacket(deref_packet) => { buf.set_mc_var_int(12); deref_packet.encode(buf); },
        BossEventPacket(deref_packet) => { buf.set_mc_var_int(13); deref_packet.encode(buf); },
        ChangeDifficultyPacket(deref_packet) => { buf.set_mc_var_int(14); deref_packet.encode(buf); },
        ChatPacket(deref_packet) => { buf.set_mc_var_int(15); deref_packet.encode(buf); },
        ChunkBlocksUpdatePacket(deref_packet) => { buf.set_mc_var_int(16); deref_packet.encode(buf); },
        CommandSuggestionsPacket(deref_packet) => { buf.set_mc_var_int(17); deref_packet.encode(buf); },
        CommandsPacket(deref_packet) => { buf.set_mc_var_int(18); deref_packet.encode(buf); },
        ContainerAckPacket(deref_packet) => { buf.set_mc_var_int(19); deref_packet.encode(buf); },
        ContainerClosePacket(deref_packet) => { buf.set_mc_var_int(20); deref_packet.encode(buf); },
        ContainerSetContentPacket(deref_packet) => { buf.set_mc_var_int(21); deref_packet.encode(buf); },
        ContainerSetDataPacket(deref_packet) => { buf.set_mc_var_int(22); deref_packet.encode(buf); },
        ContainerSetSlotPacket(deref_packet) => { buf.set_mc_var_int(23); deref_packet.encode(buf); },
        CooldownPacket(deref_packet) => { buf.set_mc_var_int(24); deref_packet.encode(buf); },
        CustomPayloadPacket(deref_packet) => { buf.set_mc_var_int(25); deref_packet.encode(buf); },
        CustomSoundPacket(deref_packet) => { buf.set_mc_var_int(26); deref_packet.encode(buf); },
        DisconnectPacket(deref_packet) => { buf.set_mc_var_int(27); deref_packet.encode(buf); },
        EntityEventPacket(deref_packet) => { buf.set_mc_var_int(28); deref_packet.encode(buf); },
        ExplodePacket(deref_packet) => { buf.set_mc_var_int(29); deref_packet.encode(buf); },
        ForgetLevelChunkPacket(deref_packet) => { buf.set_mc_var_int(30); deref_packet.encode(buf); },
        GameEventPacket(deref_packet) => { buf.set_mc_var_int(31); deref_packet.encode(buf); },
        HorseScreenOpenPacket(deref_packet) => { buf.set_mc_var_int(32); deref_packet.encode(buf); },
        KeepAlivePacket(deref_packet) => { buf.set_mc_var_int(33); deref_packet.encode(buf); },
        LevelChunkPacket(deref_packet) => { buf.set_mc_var_int(34); deref_packet.encode(buf); },
        LevelEventPacket(deref_packet) => { buf.set_mc_var_int(35); deref_packet.encode(buf); },
        LevelParticlesPacket(deref_packet) => { buf.set_mc_var_int(36); deref_packet.encode(buf); },
        LightUpdatePacket(deref_packet) => { buf.set_mc_var_int(37); deref_packet.encode(buf); },
        LoginPacket(deref_packet) => { buf.set_mc_var_int(38); deref_packet.encode(buf); },
        MapItemDataPacket(deref_packet) => { buf.set_mc_var_int(39); deref_packet.encode(buf); },
        MerchantOffersPacket(deref_packet) => { buf.set_mc_var_int(40); deref_packet.encode(buf); },
        MoveEntityPosPacket(deref_packet) => { buf.set_mc_var_int(41); deref_packet.encode(buf); },
        MoveEntityPosRotPacket(deref_packet) => { buf.set_mc_var_int(42); deref_packet.encode(buf); },
        MoveEntityRotPacket(deref_packet) => { buf.set_mc_var_int(43); deref_packet.encode(buf); },
        MoveEntityPacket(deref_packet) => { buf.set_mc_var_int(44); deref_packet.encode(buf); },
        MoveVehiclePacket(deref_packet) => { buf.set_mc_var_int(45); deref_packet.encode(buf); },
        OpenBookPacket(deref_packet) => { buf.set_mc_var_int(46); deref_packet.encode(buf); },
        OpenScreenPacket(deref_packet) => { buf.set_mc_var_int(47); deref_packet.encode(buf); },
        OpenSignEditorPacket(deref_packet) => { buf.set_mc_var_int(48); deref_packet.encode(buf); },
        PlaceGhostRecipePacket(deref_packet) => { buf.set_mc_var_int(49); deref_packet.encode(buf); },
        PlayerAbilitiesPacket(deref_packet) => { buf.set_mc_var_int(50); deref_packet.encode(buf); },
        PlayerCombatPacket(deref_packet) => { buf.set_mc_var_int(51); deref_packet.encode(buf); },
        PlayerInfoPacket(deref_packet) => { buf.set_mc_var_int(52); deref_packet.encode(buf); },
        PlayerLookAtPacket(deref_packet) => { buf.set_mc_var_int(53); deref_packet.encode(buf); },
        PlayerPositionPacket(deref_packet) => { buf.set_mc_var_int(54); deref_packet.encode(buf); },
        RecipePacket(deref_packet) => { buf.set_mc_var_int(55); deref_packet.encode(buf); },
        RemoveEntitiesPacket(deref_packet) => { buf.set_mc_var_int(56); deref_packet.encode(buf); },
        RemoveMobEffectPacket(deref_packet) => { buf.set_mc_var_int(57); deref_packet.encode(buf); },
        ResourcePackPacket(deref_packet) => { buf.set_mc_var_int(58); deref_packet.encode(buf); },
        RespawnPacket(deref_packet) => { buf.set_mc_var_int(59); deref_packet.encode(buf); },
        RotateHeadPacket(deref_packet) => { buf.set_mc_var_int(60); deref_packet.encode(buf); },
        SelectAdvancementsTabPacket(deref_packet) => { buf.set_mc_var_int(61); deref_packet.encode(buf); },
        SetBorderPacket(deref_packet) => { buf.set_mc_var_int(62); deref_packet.encode(buf); },
        SetCameraPacket(deref_packet) => { buf.set_mc_var_int(63); deref_packet.encode(buf); },
        SetCarriedItemPacket(deref_packet) => { buf.set_mc_var_int(64); deref_packet.encode(buf); },
        SetChunkCacheCenterPacket(deref_packet) => { buf.set_mc_var_int(65); deref_packet.encode(buf); },
        SetChunkCacheRadiusPacket(deref_packet) => { buf.set_mc_var_int(66); deref_packet.encode(buf); },
        SetDisplayObjectivePacket(deref_packet) => { buf.set_mc_var_int(67); deref_packet.encode(buf); },
        SetEntityDataPacket(deref_packet) => { buf.set_mc_var_int(68); deref_packet.encode(buf); },
        SetEntityLinkPacket(deref_packet) => { buf.set_mc_var_int(69); deref_packet.encode(buf); },
        SetEntityMotionPacket(deref_packet) => { buf.set_mc_var_int(70); deref_packet.encode(buf); },
        SetEquippedItemPacket(deref_packet) => { buf.set_mc_var_int(71); deref_packet.encode(buf); },
        SetExperiencePacket(deref_packet) => { buf.set_mc_var_int(72); deref_packet.encode(buf); },
        SetHealthPacket(deref_packet) => { buf.set_mc_var_int(73); deref_packet.encode(buf); },
        SetObjectivePacket(deref_packet) => { buf.set_mc_var_int(74); deref_packet.encode(buf); },
        SetPassengersPacket(deref_packet) => { buf.set_mc_var_int(75); deref_packet.encode(buf); },
        SetPlayerTeamPacket(deref_packet) => { buf.set_mc_var_int(76); deref_packet.encode(buf); },
        SetScorePacket(deref_packet) => { buf.set_mc_var_int(77); deref_packet.encode(buf); },
        SetSpawnPositionPacket(deref_packet) => { buf.set_mc_var_int(78); deref_packet.encode(buf); },
        SetTimePacket(deref_packet) => { buf.set_mc_var_int(79); deref_packet.encode(buf); },
        SetTitlesPacket(deref_packet) => { buf.set_mc_var_int(80); deref_packet.encode(buf); },
        SoundEntityPacket(deref_packet) => { buf.set_mc_var_int(81); deref_packet.encode(buf); },
        SoundPacket(deref_packet) => { buf.set_mc_var_int(82); deref_packet.encode(buf); },
        StopSoundPacket(deref_packet) => { buf.set_mc_var_int(83); deref_packet.encode(buf); },
        TabListPacket(deref_packet) => { buf.set_mc_var_int(84); deref_packet.encode(buf); },
        TagQueryPacket(deref_packet) => { buf.set_mc_var_int(85); deref_packet.encode(buf); },
        TakeItemEntityPacket(deref_packet) => { buf.set_mc_var_int(86); deref_packet.encode(buf); },
        TeleportEntityPacket(deref_packet) => { buf.set_mc_var_int(87); deref_packet.encode(buf); },
        UpdateAdvancementsPacket(deref_packet) => { buf.set_mc_var_int(88); deref_packet.encode(buf); },
        UpdateAttributesPacket(deref_packet) => { buf.set_mc_var_int(89); deref_packet.encode(buf); },
        UpdateMobEffectPacket(deref_packet) => { buf.set_mc_var_int(90); deref_packet.encode(buf); },
        UpdateRecipesPacket(deref_packet) => { buf.set_mc_var_int(91); deref_packet.encode(buf); },
        UpdateTagsPacket(deref_packet) => { buf.set_mc_var_int(92); deref_packet.encode(buf); },
    }
}
